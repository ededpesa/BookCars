                    ...
                    <div className="car">
                      ...
                      {!hideSupplier && (
                        ...
                        >
                          ...
                          <a
                            href={`/supplier?c=${car.supplier._id}`}
                            className="car-supplier-info"
                          >
                            ...
                            <Tooltip
                              title={
                                booking
                                  ...
                                  : car.gps > -1
                                    ? strings.GPS_TOOLTIP
                                    : helper.getGps(car.gps, language as string)
                              }
                              placement="left"
                            >
                              <div className="car-info-list-item">
                            ...
                            <Tooltip
                              title={
                                booking
                                  ? ""
                                  : car.homeDelivery > -1
                                    ? strings.HOME_DELIVERYS_TOOLTIP
                                    : helper.getGps(
                                        car.homeDelivery,
                                        language as string,
                                      )

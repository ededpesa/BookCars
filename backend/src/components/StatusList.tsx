...
const StatusList = ({ value: statusListValue, label, required, variant, disabled, style, onChange }: StatusListProps) => {
    ...
    <div style={style || {}}>
      {disabled ? (
        ...
        <>
          ...
          >
            <MenuItem value={bookcarsTypes.BookingStatus.Void} className="bs-s bs-s-void bold">

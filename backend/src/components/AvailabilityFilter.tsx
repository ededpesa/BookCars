...
const AvailabilityFilter = ({
  ...
  return (
    <Accordion
      ...
      className={`${className ? `${className} ` : ""}availability-filter`}
    >
      <div className="filter-elements">
        <div className="filter-element">
          ...
          />
          <span role="button" tabIndex={0} onClick={handleAvailableClick}>
            {strings.AVAILABLE}
          </span>
        </div>
        <div className="filter-element">
          ...
          />
          <span role="button" tabIndex={0} onClick={handleUnavailableClick}>
            {strings.UNAVAILABLE}
          </span>
        </div>

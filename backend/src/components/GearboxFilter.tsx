...
const GearboxFilter = ({ className, onChange }: GearboxFilterProps) => {
  ...
  const handleCheckAutomaticChange = (
  ...
  return (
    <Accordion
      ...
      className={`${className ? `${className} ` : ""}gearbox-filter`}
    >
      <div className="filter-elements">
        <div className="filter-element">
          ...
          />
          <span role="button" tabIndex={0} onClick={handleAutomaticClick}>
        ...
        <div className="filter-element">
          ...
          />
          <span role="button" tabIndex={0} onClick={handleManualClick}>

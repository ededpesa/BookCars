...
const Car = () => {
  ...
  const edit =
    ...
    car &&
    car.supplier &&
    (user.type === bookcarsTypes.RecordType.Admin ||
      user._id === car.supplier._id);
              ...
              <div className="car-info">
                <ul className="car-info-list">
                  ...
                  <li className="mileage">
                    <Tooltip
                      title={helper.getMileageTooltip(car.mileage, language)}
                      placement="left"
                    >
                      <div className="car-info-list-item">
                        <MileageIcon />
                    ...
                    <Tooltip
                      title={
                        car.cancellation > -1
                          ...
                          : helper.getCancellation(car.cancellation, language)
                      }
                      placement="left"
                    >
                      <div className="car-info-list-item">
                    ...
                    <Tooltip
                      title={
                        car.fullInsurance > -1
                          ...
                          : helper.getFullInsurance(car.fullInsurance, language)
                      }
                      placement="left"
                    >
                      <div className="car-info-list-item">

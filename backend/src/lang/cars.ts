...
const strings = new LocalizedStrings({
  fr: {
    ...
    PAY_LATER_FEE: "Frais de paiement tardif",
    PERCENTAGE_FINAL_PRICE: "Pourcentage du prix final",
  ...
  en: {
    ...
    PAY_LATER_FEE: "Pay later fee",
    PERCENTAGE_FINAL_PRICE: "Percentage of final price",
  ...
  es: {
    ...
    PAY_LATER_FEE: "Tarifa de pago tardío",
    PERCENTAGE_FINAL_PRICE: "Porcentaje del precio final",

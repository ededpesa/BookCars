...
export const validate = (
  data: bookcarsTypes.ValidateLocationPayload,
): Promise<number> =>
  axiosInstance
    .post("/api/validate-location", data, { withCredentials: true })
    .then((res) => res.status);
...
export const create = (data: bookcarsTypes.LocationName[]): Promise<number> =>
  axiosInstance
    .post("/api/create-location", data, { withCredentials: true })
    .then((res) => res.status);
...
export const update = (
  id: string,
  data: bookcarsTypes.LocationName[],
): Promise<number> =>
  axiosInstance
    .put(`/api/update-location/${id}`, data, { withCredentials: true })
    .then((res) => res.status);
...
export const deleteLocation = (id: string): Promise<number> =>
  axiosInstance
    .delete(`/api/delete-location/${encodeURIComponent(id)}`, {
...
export const check = (id: string): Promise<number> =>
  axiosInstance
    .get(`/api/check-location/${encodeURIComponent(id)}`, {
      withCredentials: true,
    })
    .then((res) => res.status);

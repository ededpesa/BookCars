...
export const notificationCounter = async (req: Request, res: Response) => {
  ...
  try {
    ...
    logger.error(
      `[notification.notificationCounter] ${i18n.t("DB_ERROR")} ${userId}`,
      err,
    );
...
export const getNotifications = async (req: Request, res: Response) => {
  ...
  try {
    ...
    logger.error(
      `[notification.getNotifications] ${i18n.t("DB_ERROR")} ${_userId}`,
      err,
    );
...
export const deleteNotifications = async (req: Request, res: Response) => {
  try {
    ...
    logger.error(
      `[notification.deleteNotifications] ${i18n.t("DB_ERROR")}`,
      err,
    );
    return res.status(400).send(i18n.t("DB_ERROR") + err);
  }

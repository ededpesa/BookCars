...
const strings = new LocalizedStrings({
  ...
  es: {
    ...
    FUEL_POLICY_LIKE_FOR_LIKE_TOOLTIP: "Este vehículo se suministra con combustible y debe devolverse con la misma cantidad de combustible.",
    FUEL_POLICY_FREE_TANK_TOOLTIP: "El precio incluye el depósito lleno de combustible.",
    MILEAGE: "Kilometraje",
    MILEAGE_UNIT: "KM/day",
    UNLIMITED: "Ilimitado",
    LIMITED: "Limitado",
    ...
    COLLISION_DAMAGE_WAVER: "Exención de responsabilidad por daños por colisión",
    COLLISION_DAMAGE_WAVER_TOOLTIP: "El alquiler puede incluir la exención de daños por colisión.",

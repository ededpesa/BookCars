...
const strings = new LocalizedStrings({
  ...
  es: {
    ...
    FUEL_POLICY_FREE_TANK: "Tanque libre",
    DIESEL_TOOLTIP: "Este vehículo tiene motor diesel",
    GASOLINE_TOOLTIP: "Este vehículo tiene motor de gasolina",
    ELECTRIC_TOOLTIP: "Este auto es electrico",
    HYBRID_TOOLTIP: "Este auto es hibrido",
    PLUG_IN_HYBRID_TOOLTIP: "Este vehículo es híbrido enchufable",
    GEARBOX_MANUAL_TOOLTIP: "Este vehículo tiene caja de cambios manual",
    GEARBOX_AUTOMATIC_TOOLTIP: "Este vehículo tiene caja de cambios automática",
    ...
    FUEL_POLICY_LIKE_FOR_LIKE_TOOLTIP:
      "Este vehículo se suministra con combustible y debe devolverse con la misma cantidad de combustible.",
    FUEL_POLICY_FREE_TANK_TOOLTIP:
      "El precio incluye el depósito lleno de combustible.",
    MILEAGE: "Kilometraje",
    MILEAGE_UNIT: "KM/day",
    UNLIMITED: "Ilimitado",
    LIMITED: "Limitado",
    ...
    CANCELLATION_TOOLTIP:
      "La reserva se puede cancelar antes de la fecha de inicio del alquiler.",
    AMENDMENTS: "Enmiendas",
    AMENDMENTS_TOOLTIP:
      "La reserva se puede modificar antes de la fecha de inicio del alquiler.",
    GPS: "GPS",
    ...
    COLLISION_DAMAGE_WAVER:
      "Exención de responsabilidad por daños por colisión",
    COLLISION_DAMAGE_WAVER_TOOLTIP:
      "El alquiler puede incluir la exención de daños por colisión.",
    ...
    EMPTY_LIST: "Sin vehículos.",
    BOOK: "Elija este vehículo",
    PRICE_DAYS_PART_1: "Precio por",
    PRICE_DAYS_PART_2: "día",
    PRICE_PER_DAY: "Precio po día:",
